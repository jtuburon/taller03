  ...
  //  tw_ID:  ID of tweet(s) to display
{
  ...
  var  col;				// Twitter user URL color
  var  h;				// Canvas height
  ...
  for( i = 0; i < tw_ID.length; i++ ) {
    ...
    info_dlg.dialog(			// Display dialog
      {
        title: "Detalles del Tweet",		// Dialog title
  ...
  //  Populate dialog with tweet's formatted text
    ...
    txt = txt + "</i></p>";
    txt = txt + "<p><i>v_m</i> = " + tweet.v_m.toFixed( 2 ) + ", ";
    txt = txt + "<i>a_m</i> = " + tweet.a_m.toFixed( 2 ) + "</p>";
/*
